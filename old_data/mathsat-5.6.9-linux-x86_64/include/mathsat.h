/* -*- C -*-
 * 
 * MathSAT5 is copyrighted 2009-2022 by Fondazione Bruno Kessler, Trento, Italy,
 ...
 * \param env The environment in which to operate
 * \param tp The type to check
 * \param out_exp_width Pointer to a variable where to store the number
 *                      of values in the enum (can be NULL)
 * \param out_mant_width Pointer to a variable where to store the list of values
 *                       in the enum (can be NULL)
