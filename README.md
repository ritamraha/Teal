...
Both the experimental results, Table 3 and Figure 2, will be saved in the root directory with an suffix `-original` and `-subset` depending on which benchmark the results are displayed.